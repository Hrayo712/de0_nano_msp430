...
.LVL58:
	.loc 1 175 0
	CMP.W	#0, 4(R1) { JEQ	.L83
.LVL59:
.L38:
	.loc 1 181 0
	CMP.W	#1, 4(R1) { JEQ	.L84
	.loc 1 187 0
	CMP.W	#2, 4(R1) { JEQ	.L85
	.loc 1 193 0
	CMP.W	#3, 4(R1) { JEQ	.L86
	.loc 1 199 0
	CMP.W	#4, 4(R1) { JEQ	.L87
	.loc 1 205 0
	CMP.W	#5, 4(R1) { JEQ	.L88
	.loc 1 174 0
	MOV.B	#4, R14
	MOV.B	#0, R15
.LVL60:
...
.LVL68:
	ADDC	#0, R15
.LVL69:
	CMP.W	#1304, R14 { JNE	.L51
	CMP.W	#0, R15 { JNE	.L51
.LVL70:
	.loc 1 172 0
	CMP.W	#7, 6(R1) { JEQ	.L90
.LVL71:
.L58:
	ADD.W	#1, 4(R1)
	ADD.W	#1, 6(R1)
...
.LBE44:
	...
	ADD.W	R14, 16(R1)
	.loc 1 188 0
	ADD	#13, 8(R1) { ADDC	#0, 10(R1)
.LVL121:
	CMP.W	#1304, R5 { JEQ	.L58
.LBB47:
.LBB46:
	.loc 1 127 0
	MOV.W	R5, R12
