# 1 "../main.c"
# 1 "/home/hiram/eclipse-workspace/cuckoo/Debug//"
# 1 "<built-in>"
#define __STDC__ 1
           ...
           insert(fingerprint_t *filter, value_t key)
{
    ...
    if (!fp1) {
        ...
        if (!fp2) {
            ...
            } while (fp_victim && ++relocation_count < 8);
...
# 304 "../main.c"
    ...
    static fingerprint_t filter[256];
...
# 341 "../main.c"
       ...
       print_filter(filter);
       print_stats(inserts, members, (256 / 4));
