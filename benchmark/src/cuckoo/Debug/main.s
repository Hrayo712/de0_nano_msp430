...
.LCFI4:
	...
	MOV.W	R14, R8
	.loc 1 136 0
	MOV.W	#UART_WriteString, R10
	MOV.W	#.LC0, R12
.LVL3:
	CALL	R10
.LVL4:
	.loc 1 137 0
	MOV.W	#UART_WriteNumber, R9
	MOV.W	R6, R12
	CALL	R9
.LVL5:
	.loc 1 138 0
...
.LBE151:
	...
	.loc 1 284 0
	ADD.W	R4, R4
	CMP.W	filter.2353(R4), R10 { JEQ	.L27
.LVL41:
.LBE150:
.LBE149:
	.loc 1 344 0
...
.LBE158:
	.loc 1 284 0
	ADD.W	R12, R12
	CMP.W	filter.2353(R12), R10 { JNE	.L13
.L27:
	ADD.W	#1, 6(R1)
.LVL57:
	ADD.W	#-1, R8
...
.Ldebug_macinfo0:
	...
	.byte	0x4
	.file 29 "/home/hiram/git/de0_nano_msp430/altera_de0_nano/software/libs/omsp_system.h"
	.byte	0x3
	.uleb128 0x18
	.uleb128 0x1d
	.file 30 "/opt/ti/ccsv8/ccs_base/msp430/include_gcc/in430.h"
	.byte	0x3
	.uleb128 0x24
	.uleb128 0x1e
	.byte	0x1
