...
int main(void)
{
    ...
    #ifdef UART_DBG
    UART_WriteString("Benchmark Start\r\n");
    #endif
    ...
    //TSW to know the amount of checkpoints
    //UART_WriteNumber(*((int*)(0x6076)));
    return 0;
}
...
static void test_encrypt_ecb_verbose(void)
{
    ...
    #ifdef UART_DBG
        UART_WriteString("\r\n");
        UART_WriteString("ECB encrypt verbose:\r\n");
        UART_WriteString("plain text:\r\n");
    ...
    {
        UART_WriteString_HEX(&plain_text[i*16],16);
        UART_WriteString("\r\n");
    ...
    UART_WriteString("key:\r\n");
    //printf("key:\n");
    UART_WriteString_HEX(key,16);
    //phex(key);
    ...
    for(i = 0; i < 4; ++i)
    {
        ...
        #ifdef UART_DBG
            UART_WriteString_HEX(&buf[i*16],16);
            UART_WriteString("\r\n");
        //phex(buf + (i*16));
        #endif
