...
# 311 "qwark.c"
  ...
  __asm__ __volatile__ ("mov r13,@r12");
  __asm__ __volatile__ ("incd r12");
...
# 435 "qwark.c"
  ...
  __asm__ __volatile__ ("mov  r1,       r10 ");
  __asm__ __volatile__ ("cmp  r10  ,    r13 ");
  __asm__ __volatile__ ("jeq  _pre_end_copy ");

  __asm__ __volatile__ ("incd r10 	  ");
  __asm__ __volatile__ ("cmp  r10,      r13 ");
  __asm__ __volatile__ ("jeq  _pre_end_copy ");
