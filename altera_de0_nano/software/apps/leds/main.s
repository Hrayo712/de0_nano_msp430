...
.LVL49:
	MOV.W	#bits, R9
	MOV.W	#UART_WriteString, R4
	MOV.W	#UART_WriteNumber, R5
.L48:
	.loc 1 148 0
	XOR.B	#15, &144
	.loc 1 152 0
...
.LBE34:
	.loc 1 165 0
	CMP.W	#0, 4(R1) { JEQ	.L68
.LVL52:
.L27:
	.loc 1 171 0
	CMP.W	#1, 4(R1) { JEQ	.L69
	.loc 1 177 0
	CMP.W	#2, 4(R1) { JEQ	.L70
	.loc 1 183 0
	CMP.W	#3, 4(R1) { JEQ	.L71
	.loc 1 189 0
	CMP.W	#4, 4(R1) { JEQ	.L72
	.loc 1 195 0
	CMP.W	#5, 4(R1) { JEQ	.L73
	.loc 1 164 0
	MOV.B	#4, R14
	MOV.B	#0, R15
.LVL53:
